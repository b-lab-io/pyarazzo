...
class ArazzoVisitor(ABC):
    ...
    @abstractmethod
    def visit_specification(self, instance: ArazzoSpec):
        pass
...
class Info(ArazzoElement):
    title: Annotated[
        str, Field(description='A human readable title of the Arazzo Description')
    ]
    summary: Annotated[
        Optional[str], Field(description='A short summary of the Arazzo Description')
    ] = None
...
class SourceDescriptionObject(ArazzoElement):
    ...
    url: Annotated[
        str, Field(description='A URL to a source description to be used by a workflow')
    ]
    type: Annotated[
        Optional[SourceType], Field(description='The type of source description')
    ] = None

    def accept(self, visitor:ArazzoVisitor):
        return visitor.visit_source_decription_object(self)
...
class CriterionExpressionTypeObject(ArazzoElement):
    ...
    def accept(self, visitor:ArazzoVisitor):
        return visitor.visit_criterion_expression_type_object(self)
...
class ReusableObject(ArazzoElement):
    ...
    def accept(self, visitor:ArazzoVisitor):
        return visitor.visit_reusable_object(self)
...
class PayloadReplacementObject(ArazzoElement):
    ...
    value: Annotated[str, Field(description='The value list within the target location')]

    def accept(self, visitor:ArazzoVisitor):
        return visitor.visit_payload_replacement_object(self)
...
class SchemaArray(RootModel):
    root: Annotated[List[Any], Field(min_items=1)]
...
class RequestBodyObject(BaseModel):
    contentType: Annotated[
        Optional[str], Field(description='The Content-Type for the request content')
    ] = None
...
class Cor(BaseModel):
    ...
    field_vocabulary: Annotated[
        Optional[Dict[str, bool]], Field(alias='$vocabulary')
    ] = None
...
class Type4(RootModel):
    root: Annotated[list[SimpleTypes], Field(min_items=1)]
...
class Schem(Cor, Applicato, Unevaluate, Validatio, MetaDat, FormatAnnotatio, Conten):
...
class Workflow(ArazzoElement):
    workflowId: Annotated[
        str, Field(description='Unique string to represent the workflow')
    ]
    summary: Annotated[
        Optional[str],
...
class ArazzoSpec(ArazzoElement):
    arazzo: Annotated[
        str,
        Field(
    ...
    workflows: Annotated[
        list[Workflow],
        Field(description='A list of workflows', min_items=1),
    ]
...
class ArazzoLoader:
    ...
    @staticmethod
    def load(url:str) -> ArazzoSpec:
        spec_dict = load_spec(url)
        return  ArazzoSpec(**spec_dict)
